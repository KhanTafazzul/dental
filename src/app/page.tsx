...
import { Sparkles, MapPin, ArrowRight, Heart, Star, Shield, CheckCircle2, User, LogOut, ShieldCheck, Lock, Settings } from 'lucide-react'
      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {patientUser ? (
              <div className="flex items-center gap-2 bg-slate-900/90 border border-white/10 text-white px-3 py-1.5 rounded-2xl shadow-xl text-xs">
                <User className="w-3.5 h-3.5 text-teal-400" />
                <span className="font-semibold max-w-[120px] truncate">{patientUser.fullName}</span>
                <Link
                  href="/account"
                  title="My Patient Account"
                  className="px-2.5 py-1 rounded-xl bg-teal-500/20 hover:bg-teal-500/30 text-teal-300 text-[11px] font-semibold transition-colors flex items-center gap-1 border border-teal-500/30"
                >
